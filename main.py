...
#
#
# # Function to handle corrections and store them
# def track_corrections(text):
#     mistake_pairs = re.findall(r'"([^"]+)" should be "([^"]+)"', text)
#     for incorrect_word, correct_word in mistake_pairs:
#         if correct_word not in corrected_words:
...
#     if user_input:
#         # Process the conversation as before
...
#                If the child makes any spelling or grammar mistakes, correct them and show only the incorrect words and their corrections.
#
#                Format:
#                Mistakes: "wrong_word" should be "correct_word"
#
#                User: {input}
#                AI:"""
#         )
...
#
#         # Track corrections using the Correction Agent
#         track_corrections(ai_response)
#
